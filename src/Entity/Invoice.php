...
class Invoice
{
    ...
    /**
     * @ORM\OneToOne(targetEntity=Purchase::class, inversedBy="invoice", cascade={"persist", "remove"})
    ...
    /**
     * @ORM\OneToMany(targetEntity=ContentInvoice::class, mappedBy="invoice", orphanRemoval=true)
     */
