 ...
 */
final class Version20220204104732 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE content_invoice ADD price_product INT NOT NULL, ADD image_product VARCHAR(255) NOT NULL, ADD quantity INT NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE content_invoice DROP price_product, DROP image_product, DROP quantity, CHANGE product_name product_name VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
